const translations = {
  pt: {
    ...
    "vagas.banner.titulo": "Mestrado e Doutorado em Sensoriamento Remoto aplicado à Agricultura",
    "vagas.banner.descricao": "O AgriRS Lab pertence à Divisão de Sensoriamento Remoto do INPE e desenvolve pesquisa e desenvolvimento em geoinformática e sensoriamento remoto para agricultura...",
    "vagas.banner.botao": "Ver inscrições",
    "vagas.oportunidades.titulo": "🌱 Oportunidades de Trabalho",
    "vagas.requisitos": "Requisitos:",
    "vagas.inscreva_se": "Inscreva-se",
    "vagas.nenhuma_vaga": "Nenhuma vaga aberta no momento. Volte em breve!",
    "vagas.inscricoes.titulo": "📄 Inscrições para Mestrado e Doutorado",
    "vagas.inscricoes.texto": "As inscrições são centralizadas pelo Programa de Pós Graduação em Sensoriamento Remoto do INPE. Acesse o link para editais e orientações.",
    "vagas.inscricoes.botao": "Abrir página de inscrições e editais do PGSER",    
    "vagas.inscricoes.contato_texto": "Contato da secretaria do programa:",
    "vagas.linhas_pesquisa.titulo": "📊 Linhas de pesquisa e temas",
    "vagas.linhas_pesquisa.card1_titulo": "Agricultura de precisão",
    "vagas.linhas_pesquisa.card1_texto": "Variabilidade espacial, sensores em campo e integração com dados de máquinas.",
    "vagas.linhas_pesquisa.card2_titulo": "Imagens orbitais e aéreas",
    "vagas.linhas_pesquisa.card2_texto": "Uso de satélites e VANTs para monitoramento de culturas e fenologia.",
    "vagas.linhas_pesquisa.card3_titulo": "Processamento e modelagem",
    "vagas.linhas_pesquisa.card3_texto": "Processamento de imagens, séries temporais e aprendizado de máquina aplicado ao agro.",
    "vagas.linhas_pesquisa.detalhes": "As linhas específicas do PGSER incluem áreas como sensoriamento remoto aplicado à agricultura, processamento de imagens e geoprocessamento. Consulte a página do programa para a lista completa e atualizada.",
    "vagas.como_ingressar.titulo": "📥 Como ingressar",
    ...
    "vagas.como_ingressar.passo2_titulo": "2. Prepare a inscrição",
  ...
  en: {
    ...
    "vagas.oportunidades.titulo": "🌱 Job Opportunities",
    ...
    "vagas.inscricoes.titulo": "📄 Master's and PhD Applications",
    ...
    "vagas.linhas_pesquisa.titulo": "📊 Research lines and topics",
    ...
    "vagas.como_ingressar.titulo": "📥 How to apply",
